 ...
 * @p_uint32_t:	Pointer to a 32-bit unsigned value.
...
struct v4l2_ctrl_type_ops {
	bool (*equal)(const struct v4l2_ctrl *ctrl, uint32_t idx,
 ...
 */
void v4l2_ctrl_fill(uint32_t id, const char **name, enum v4l2_ctrl_type *type,
		    int64_t *min, int64_t *max, uint64_t *step, int64_t *def, uint32_t *flags);
...
struct v4l2_ctrl *v4l2_ctrl_new_std(struct v4l2_ctrl_handler *hdl,
				    const struct v4l2_ctrl_ops *ops,
				    uint32_t id, int64_t min, int64_t max, uint64_t step,
				    int64_t def);
...
struct v4l2_ctrl *v4l2_ctrl_new_std_menu(struct v4l2_ctrl_handler *hdl,
					 const struct v4l2_ctrl_ops *ops,
					 uint32_t id, uint8_t max, uint64_t mask, uint8_t def);
...
void v4l2_ctrl_auto_cluster(unsigned int ncontrols,
			    ...
			    uint8_t manual_val, bool set_volatile);
 ...
 */
struct v4l2_ctrl *v4l2_ctrl_find(struct v4l2_ctrl_handler *hdl, uint32_t id);
 ...
 * a known control.
 */
const char *v4l2_ctrl_get_name(uint32_t id);
 ...
 */
const char * const *v4l2_ctrl_get_menu(uint32_t id);
 ...
 */
const int64_t *v4l2_ctrl_get_int_menu(uint32_t id, uint32_t *len);
 ...
 */
int32_t v4l2_ctrl_g_ctrl(struct v4l2_ctrl *ctrl);
 ...
 * This function is for integer type controls only.
 */
int __v4l2_ctrl_s_ctrl(struct v4l2_ctrl *ctrl, int32_t val);
 ...
 * This function is for integer type controls only.
 */
static inline int v4l2_ctrl_s_ctrl(struct v4l2_ctrl *ctrl, int32_t val)
{
	int rval;
 ...
 */
int64_t v4l2_ctrl_g_ctrl_int64(struct v4l2_ctrl *ctrl);
 ...
 * This function is for 64-bit integer type controls only.
 */
int __v4l2_ctrl_s_ctrl_int64(struct v4l2_ctrl *ctrl, int64_t val);
 ...
 * This function is for 64-bit integer type controls only.
 */
static inline int v4l2_ctrl_s_ctrl_int64(struct v4l2_ctrl *ctrl, int64_t val)
{
	int rval;
