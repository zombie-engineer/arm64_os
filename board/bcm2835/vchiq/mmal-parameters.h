...
struct mmal_parameter_camera_config {
	...
	uint32_t max_preview_video_w; /* Max size of the preview or video
				  * capture frames
				  */
...
struct mmal_parameter_displayregion {
	 ...
	 */
	uint32_t transform; /* enum mmal_parameter_displaytransform */
	 ...
	 * necessary.
	 */
	uint32_t mode; /* enum mmal_parameter_displaymode */
...
struct mmal_parameter_camera_info_camera_t {
	...
	uint8_t     camera_name[MMAL_PARAMETER_CAMERA_INFO_MAX_STR_LEN];
};
