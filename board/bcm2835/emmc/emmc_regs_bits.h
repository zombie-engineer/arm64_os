...
#define EMMC_CARD_STATUS_GET_AKE_SEQ_ERROR(v)    BF_EXTRACT(v, 3 , 1 )
#define EMMC_CARD_STATUS_GET_APP_CMD(v)          BF_EXTRACT(v, 5 , 1 )
#define EMMC_CARD_STATUS_GET_FX_EVENT(v)         BF_EXTRACT(v, 6 , 1 )
#define EMMC_CARD_STATUS_GET_READY_FOR_DATA(v)   BF_EXTRACT(v, 8 , 1 )
#define EMMC_CARD_STATUS_GET_CURRENT_STATE(v)    BF_EXTRACT(v, 9 , 4 )
#define EMMC_CARD_STATUS_GET_ERASE_RESET(v)      BF_EXTRACT(v, 13, 1 )
#define EMMC_CARD_STATUS_GET_CARD_ECC_DISABLED(v) BF_EXTRACT(v, 14, 1 )
#define EMMC_CARD_STATUS_GET_WP_ERASE_SKIP(v)    BF_EXTRACT(v, 15, 1 )
#define EMMC_CARD_STATUS_GET_CSD_OVERWRITE(v)    BF_EXTRACT(v, 16, 1 )
#define EMMC_CARD_STATUS_GET_ERROR(v)            BF_EXTRACT(v, 19, 1 )
#define EMMC_CARD_STATUS_GET_CC_ERROR(v)         BF_EXTRACT(v, 20, 1 )
#define EMMC_CARD_STATUS_GET_CARD_ECC_FAILED(v)  BF_EXTRACT(v, 21, 1 )
#define EMMC_CARD_STATUS_GET_ILLEGAL_COMMAND(v)  BF_EXTRACT(v, 22, 1 )
#define EMMC_CARD_STATUS_GET_COM_CRC_ERROR(v)    BF_EXTRACT(v, 23, 1 )
#define EMMC_CARD_STATUS_GET_LOCK_UNLOCK_FAILED(v) BF_EXTRACT(v, 24, 1 )
#define EMMC_CARD_STATUS_GET_CARD_IS_LOCKED(v)   BF_EXTRACT(v, 25, 1 )
#define EMMC_CARD_STATUS_GET_WP_VIOLATION(v)     BF_EXTRACT(v, 26, 1 )
#define EMMC_CARD_STATUS_GET_ERASE_PARAM(v)      BF_EXTRACT(v, 27, 1 )
#define EMMC_CARD_STATUS_GET_ERASE_SEQ_ERROR(v)  BF_EXTRACT(v, 28, 1 )
#define EMMC_CARD_STATUS_GET_BLOCK_LEN_ERROR(v)  BF_EXTRACT(v, 29, 1 )
#define EMMC_CARD_STATUS_GET_ADDRESS_ERROR(v)    BF_EXTRACT(v, 30, 1 )
#define EMMC_CARD_STATUS_GET_OUT_OF_RANGE(v)     BF_EXTRACT(v, 31, 1 )
#define EMMC_CARD_STATUS_CLR_SET_AKE_SEQ_ERROR(v, set)   BF_CLEAR_AND_SET(v, set, 3 , 1 )
#define EMMC_CARD_STATUS_CLR_SET_APP_CMD(v, set)         BF_CLEAR_AND_SET(v, set, 5 , 1 )
#define EMMC_CARD_STATUS_CLR_SET_FX_EVENT(v, set)        BF_CLEAR_AND_SET(v, set, 6 , 1 )
#define EMMC_CARD_STATUS_CLR_SET_READY_FOR_DATA(v, set)  BF_CLEAR_AND_SET(v, set, 8 , 1 )
#define EMMC_CARD_STATUS_CLR_SET_CURRENT_STATE(v, set)   BF_CLEAR_AND_SET(v, set, 9 , 4 )
#define EMMC_CARD_STATUS_CLR_SET_ERASE_RESET(v, set)     BF_CLEAR_AND_SET(v, set, 13, 1 )
#define EMMC_CARD_STATUS_CLR_SET_CARD_ECC_DISABLED(v, set) BF_CLEAR_AND_SET(v, set, 14, 1 )
#define EMMC_CARD_STATUS_CLR_SET_WP_ERASE_SKIP(v, set)   BF_CLEAR_AND_SET(v, set, 15, 1 )
#define EMMC_CARD_STATUS_CLR_SET_CSD_OVERWRITE(v, set)   BF_CLEAR_AND_SET(v, set, 16, 1 )
#define EMMC_CARD_STATUS_CLR_SET_ERROR(v, set)           BF_CLEAR_AND_SET(v, set, 19, 1 )
#define EMMC_CARD_STATUS_CLR_SET_CC_ERROR(v, set)        BF_CLEAR_AND_SET(v, set, 20, 1 )
#define EMMC_CARD_STATUS_CLR_SET_CARD_ECC_FAILED(v, set) BF_CLEAR_AND_SET(v, set, 21, 1 )
#define EMMC_CARD_STATUS_CLR_SET_ILLEGAL_COMMAND(v, set) BF_CLEAR_AND_SET(v, set, 22, 1 )
#define EMMC_CARD_STATUS_CLR_SET_COM_CRC_ERROR(v, set)   BF_CLEAR_AND_SET(v, set, 23, 1 )
#define EMMC_CARD_STATUS_CLR_SET_LOCK_UNLOCK_FAILED(v, set) BF_CLEAR_AND_SET(v, set, 24, 1 )
#define EMMC_CARD_STATUS_CLR_SET_CARD_IS_LOCKED(v, set)  BF_CLEAR_AND_SET(v, set, 25, 1 )
#define EMMC_CARD_STATUS_CLR_SET_WP_VIOLATION(v, set)    BF_CLEAR_AND_SET(v, set, 26, 1 )
#define EMMC_CARD_STATUS_CLR_SET_ERASE_PARAM(v, set)     BF_CLEAR_AND_SET(v, set, 27, 1 )
#define EMMC_CARD_STATUS_CLR_SET_ERASE_SEQ_ERROR(v, set) BF_CLEAR_AND_SET(v, set, 28, 1 )
#define EMMC_CARD_STATUS_CLR_SET_BLOCK_LEN_ERROR(v, set) BF_CLEAR_AND_SET(v, set, 29, 1 )
#define EMMC_CARD_STATUS_CLR_SET_ADDRESS_ERROR(v, set)   BF_CLEAR_AND_SET(v, set, 30, 1 )
#define EMMC_CARD_STATUS_CLR_SET_OUT_OF_RANGE(v, set)    BF_CLEAR_AND_SET(v, set, 31, 1 )
#define EMMC_CARD_STATUS_CLR_AKE_SEQ_ERROR(v)    BF_CLEAR(v, 3 , 1 )
#define EMMC_CARD_STATUS_CLR_APP_CMD(v)          BF_CLEAR(v, 5 , 1 )
#define EMMC_CARD_STATUS_CLR_FX_EVENT(v)         BF_CLEAR(v, 6 , 1 )
#define EMMC_CARD_STATUS_CLR_READY_FOR_DATA(v)   BF_CLEAR(v, 8 , 1 )
#define EMMC_CARD_STATUS_CLR_CURRENT_STATE(v)    BF_CLEAR(v, 9 , 4 )
#define EMMC_CARD_STATUS_CLR_ERASE_RESET(v)      BF_CLEAR(v, 13, 1 )
#define EMMC_CARD_STATUS_CLR_CARD_ECC_DISABLED(v) BF_CLEAR(v, 14, 1 )
#define EMMC_CARD_STATUS_CLR_WP_ERASE_SKIP(v)    BF_CLEAR(v, 15, 1 )
#define EMMC_CARD_STATUS_CLR_CSD_OVERWRITE(v)    BF_CLEAR(v, 16, 1 )
#define EMMC_CARD_STATUS_CLR_ERROR(v)            BF_CLEAR(v, 19, 1 )
#define EMMC_CARD_STATUS_CLR_CC_ERROR(v)         BF_CLEAR(v, 20, 1 )
#define EMMC_CARD_STATUS_CLR_CARD_ECC_FAILED(v)  BF_CLEAR(v, 21, 1 )
#define EMMC_CARD_STATUS_CLR_ILLEGAL_COMMAND(v)  BF_CLEAR(v, 22, 1 )
#define EMMC_CARD_STATUS_CLR_COM_CRC_ERROR(v)    BF_CLEAR(v, 23, 1 )
#define EMMC_CARD_STATUS_CLR_LOCK_UNLOCK_FAILED(v) BF_CLEAR(v, 24, 1 )
#define EMMC_CARD_STATUS_CLR_CARD_IS_LOCKED(v)   BF_CLEAR(v, 25, 1 )
#define EMMC_CARD_STATUS_CLR_WP_VIOLATION(v)     BF_CLEAR(v, 26, 1 )
#define EMMC_CARD_STATUS_CLR_ERASE_PARAM(v)      BF_CLEAR(v, 27, 1 )
#define EMMC_CARD_STATUS_CLR_ERASE_SEQ_ERROR(v)  BF_CLEAR(v, 28, 1 )
#define EMMC_CARD_STATUS_CLR_BLOCK_LEN_ERROR(v)  BF_CLEAR(v, 29, 1 )
#define EMMC_CARD_STATUS_CLR_ADDRESS_ERROR(v)    BF_CLEAR(v, 30, 1 )
#define EMMC_CARD_STATUS_CLR_OUT_OF_RANGE(v)     BF_CLEAR(v, 31, 1 )
#define EMMC_CARD_STATUS_MASK_AKE_SEQ_ERROR      BF_MASK_AT_32(3, 1)
#define EMMC_CARD_STATUS_MASK_APP_CMD            BF_MASK_AT_32(5, 1)
#define EMMC_CARD_STATUS_MASK_FX_EVENT           BF_MASK_AT_32(6, 1)
#define EMMC_CARD_STATUS_MASK_READY_FOR_DATA     BF_MASK_AT_32(8, 1)
#define EMMC_CARD_STATUS_MASK_CURRENT_STATE      BF_MASK_AT_32(9, 4)
#define EMMC_CARD_STATUS_MASK_ERASE_RESET        BF_MASK_AT_32(13, 1)
#define EMMC_CARD_STATUS_MASK_CARD_ECC_DISABLED  BF_MASK_AT_32(14, 1)
#define EMMC_CARD_STATUS_MASK_WP_ERASE_SKIP      BF_MASK_AT_32(15, 1)
#define EMMC_CARD_STATUS_MASK_CSD_OVERWRITE      BF_MASK_AT_32(16, 1)
#define EMMC_CARD_STATUS_MASK_ERROR              BF_MASK_AT_32(19, 1)
#define EMMC_CARD_STATUS_MASK_CC_ERROR           BF_MASK_AT_32(20, 1)
#define EMMC_CARD_STATUS_MASK_CARD_ECC_FAILED    BF_MASK_AT_32(21, 1)
#define EMMC_CARD_STATUS_MASK_ILLEGAL_COMMAND    BF_MASK_AT_32(22, 1)
#define EMMC_CARD_STATUS_MASK_COM_CRC_ERROR      BF_MASK_AT_32(23, 1)
#define EMMC_CARD_STATUS_MASK_LOCK_UNLOCK_FAILED BF_MASK_AT_32(24, 1)
#define EMMC_CARD_STATUS_MASK_CARD_IS_LOCKED     BF_MASK_AT_32(25, 1)
#define EMMC_CARD_STATUS_MASK_WP_VIOLATION       BF_MASK_AT_32(26, 1)
#define EMMC_CARD_STATUS_MASK_ERASE_PARAM        BF_MASK_AT_32(27, 1)
#define EMMC_CARD_STATUS_MASK_ERASE_SEQ_ERROR    BF_MASK_AT_32(28, 1)
#define EMMC_CARD_STATUS_MASK_BLOCK_LEN_ERROR    BF_MASK_AT_32(29, 1)
#define EMMC_CARD_STATUS_MASK_ADDRESS_ERROR      BF_MASK_AT_32(30, 1)
#define EMMC_CARD_STATUS_MASK_OUT_OF_RANGE       BF_MASK_AT_32(31, 1)
#define EMMC_CARD_STATUS_SHIFT_AKE_SEQ_ERROR     3
#define EMMC_CARD_STATUS_SHIFT_APP_CMD           5
#define EMMC_CARD_STATUS_SHIFT_FX_EVENT          6
#define EMMC_CARD_STATUS_SHIFT_READY_FOR_DATA    8
#define EMMC_CARD_STATUS_SHIFT_CURRENT_STATE     9
#define EMMC_CARD_STATUS_SHIFT_ERASE_RESET       13
#define EMMC_CARD_STATUS_SHIFT_CARD_ECC_DISABLED 14
#define EMMC_CARD_STATUS_SHIFT_WP_ERASE_SKIP     15
#define EMMC_CARD_STATUS_SHIFT_CSD_OVERWRITE     16
#define EMMC_CARD_STATUS_SHIFT_ERROR             19
#define EMMC_CARD_STATUS_SHIFT_CC_ERROR          20
#define EMMC_CARD_STATUS_SHIFT_CARD_ECC_FAILED   21
#define EMMC_CARD_STATUS_SHIFT_ILLEGAL_COMMAND   22
#define EMMC_CARD_STATUS_SHIFT_COM_CRC_ERROR     23
#define EMMC_CARD_STATUS_SHIFT_LOCK_UNLOCK_FAILED 24
#define EMMC_CARD_STATUS_SHIFT_CARD_IS_LOCKED    25
#define EMMC_CARD_STATUS_SHIFT_WP_VIOLATION      26
#define EMMC_CARD_STATUS_SHIFT_ERASE_PARAM       27
#define EMMC_CARD_STATUS_SHIFT_ERASE_SEQ_ERROR   28
#define EMMC_CARD_STATUS_SHIFT_BLOCK_LEN_ERROR   29
#define EMMC_CARD_STATUS_SHIFT_ADDRESS_ERROR     30
#define EMMC_CARD_STATUS_SHIFT_OUT_OF_RANGE      31


static inline int emmc_card_status_to_string(char *buf, int bufsz, uint32_t v)
{
  return snprintf(buf, bufsz, "%08x,AKE_SEQ_ERROR:%x,APP_CMD:%x,FX_EVENT:%x,READY_FOR_DATA:%x,CURRENT_STATE:%x,ERASE_RESET:%x,CARD_ECC_DISABLED:%x,WP_ERASE_SKIP:%x,CSD_OVERWRITE:%x,ERROR:%x,CC_ERROR:%x,CARD_ECC_FAILED:%x,ILLEGAL_COMMAND:%x,COM_CRC_ERROR:%x,LOCK_UNLOCK_FAILED:%x,CARD_IS_LOCKED:%x,WP_VIOLATION:%x,ERASE_PARAM:%x,ERASE_SEQ_ERROR:%x,BLOCK_LEN_ERROR:%x,ADDRESS_ERROR:%x,OUT_OF_RANGE:%x",
    v,
    (int)EMMC_CARD_STATUS_GET_AKE_SEQ_ERROR(v),
    (int)EMMC_CARD_STATUS_GET_APP_CMD(v),
    (int)EMMC_CARD_STATUS_GET_FX_EVENT(v),
    (int)EMMC_CARD_STATUS_GET_READY_FOR_DATA(v),
    (int)EMMC_CARD_STATUS_GET_CURRENT_STATE(v),
    (int)EMMC_CARD_STATUS_GET_ERASE_RESET(v),
    (int)EMMC_CARD_STATUS_GET_CARD_ECC_DISABLED(v),
    (int)EMMC_CARD_STATUS_GET_WP_ERASE_SKIP(v),
    (int)EMMC_CARD_STATUS_GET_CSD_OVERWRITE(v),
    (int)EMMC_CARD_STATUS_GET_ERROR(v),
    (int)EMMC_CARD_STATUS_GET_CC_ERROR(v),
    (int)EMMC_CARD_STATUS_GET_CARD_ECC_FAILED(v),
    (int)EMMC_CARD_STATUS_GET_ILLEGAL_COMMAND(v),
    (int)EMMC_CARD_STATUS_GET_COM_CRC_ERROR(v),
    (int)EMMC_CARD_STATUS_GET_LOCK_UNLOCK_FAILED(v),
    (int)EMMC_CARD_STATUS_GET_CARD_IS_LOCKED(v),
    (int)EMMC_CARD_STATUS_GET_WP_VIOLATION(v),
    (int)EMMC_CARD_STATUS_GET_ERASE_PARAM(v),
    (int)EMMC_CARD_STATUS_GET_ERASE_SEQ_ERROR(v),
    (int)EMMC_CARD_STATUS_GET_BLOCK_LEN_ERROR(v),
    (int)EMMC_CARD_STATUS_GET_ADDRESS_ERROR(v),
    (int)EMMC_CARD_STATUS_GET_OUT_OF_RANGE(v));
}
